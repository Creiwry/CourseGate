...
ActiveRecord::Schema[7.0].define(version: 2023_05_30_201512) do
  ...
  create_table "forum_posts", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_forum_posts_on_student_id"
  end
  ...
  create_table "forum_threads", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "description"
    t.index ["course_id"], name: "index_forum_threads_on_course_id"
  end
